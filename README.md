...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xq-eg2k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xq-eg2k.containers.anotherwebservice.com/
...
```
git clone git@github.com:jojobearz/container-xq-eg2k.git
cd container-xq-eg2k
```
...
```
docker attach container-xq-eg2k
```
